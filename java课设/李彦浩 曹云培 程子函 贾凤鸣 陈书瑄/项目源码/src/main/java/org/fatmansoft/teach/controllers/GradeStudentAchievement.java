...
public class GradeStudentAchievement {
    @Autowired
    ...
    public List getAllCourseMapList(Integer gradeId){
        ...
        for(Course C:courseList){
            ...
            courseNameParas = "model=gradeStudentAchievementCourse&courseId="+C.getId()+"&gradeId="+gradeId;
    ...
    @PostMapping("/gradeStudentAchievementInit")
    @PreAuthorize("hasRole('ADMIN')")
    public DataResponse gradeStudentAchievementInit(@Valid @RequestBody DataRequest dataRequest) {
