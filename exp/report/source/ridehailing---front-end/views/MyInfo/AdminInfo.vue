    ...
    <div class="editable">
        ...
        <div class="substance">
            <div class="inputcontainer">
                ...
                <div style="width:60px;">密码:</div> <el-input type="password" style="width:75%;margin-left:20px;" v-model="person.password" :readonly="true"></el-input>
            </div>
            <el-divider/>
        </div>
        <div class="substance">
...
import {getAuthHeader,showPerson,getPersonImage,infoEdit} from '@/service/genServ.js'
export default {
  name: "TeacherInfo",
  components:{
    SideBarForAdmin,
