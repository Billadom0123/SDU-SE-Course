<template>
    ...
    <div class="nav">
        ...
        <span class="message" v-if="this.unChecked!=0">
            <img src="../../../icon/-xinxiaoxi.png" alt="" @click="showMessage">
        </span>
    </div>
    ...
    <div class="sidebar"  ref="sidebar">
        ...
        <el-menu class="menu" router style="flex-direction:column">
            <!-- 首页导航栏 -->
            <el-menu-item index="/index" class="menu-item" id="index">首页</el-menu-item>
        ...
        <div class="quit" @click="quit">
            <!-- <img src="../../../icon/tuichu.png" alt=""> -->
            <!-- <el-button type="info" icon="el-icon-switch-button" ></el-button> -->
            <img src="../../../icon/logout.jpg" alt="">
        </div>
    </div>
</template>

<script>
import {getPersonImage,showUnChecked} from '@/service/genServ.js';
export default {
  name: "index",
  components: {},
...
function animate(obj, target, callback) {
  ...
  methods: {
    ...
    showMessage(){
        this.$notify({
          title: '提示',
          message: '您收到了'+this.unChecked+'条新互评，快去看看吧!',
          duration: 0,
          offset:100
        });
    },
